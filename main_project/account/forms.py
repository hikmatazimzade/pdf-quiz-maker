...
class LoginForm(forms.Form):
    ...
    password = forms.CharField(validators=[MinLengthValidator(8,
                 _('Minimum length of password should be 8!'))],
...
class RegisterForm(forms.Form):
    username = forms.CharField(validators=[MinLengthValidator(7,
                            _('The minimum length of username should be 7!'))]
    ...
    password1 = forms.CharField(validators=[MinLengthValidator(8, 
                _('The minimum length of password should be 8!'))],
                widget=widgets.PasswordInput(attrs={
        'id' : 'typePasswordX',
        'class' : 'form-control form-control-lg',
        'placeholder' : _('Password')
    ...
    password2 = forms.CharField(validators=[MinLengthValidator(8,
                _('The minimum length of password should be 8!'))],
                widget=widgets.PasswordInput(attrs={
        'id' : 'typePasswordX2',
        'class' : 'form-control form-control-lg',
    ...
    def clean_username(self):
        ...
        if User.objects.filter(username=username).exists():
            self.add_error('username',
                _('The user with this username already exists!'))
...
class EmailVerificationForm(forms.Form):
    code = forms.CharField(max_length=5, validators=[MinLengthValidator(5,
                _('The length of code must be 5!')), MaxLengthValidator(5, 
                _('The length of code must be 5!'))], widget=
    ...
    def clean_code(self):
        ...
        if self.request:
            if len(code) == 5 and code != self.request.session.get \
...
class ChangePasswordForm(forms.Form):
    old_password = forms.CharField(validators=[MinLengthValidator(8,
                _('The minim password length must be 8!'))],
                widget=widgets.PasswordInput(attrs={
        'id' : 'oldPassword',
        'class' : 'form-control form-control-lg',
